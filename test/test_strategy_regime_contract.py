...
def test_normalize_strategy_config_migrates_legacy_entry_exit_into_trend_branch():
    legacy_config = {
        "indicators": {
    ...
    normalized = normalize_strategy_config(legacy_config, blank_strategy_config())
    ...
    assert normalized["trend"]["long_entry"]["children"][0]["id"] == "legacy_entry"
    assert normalized["trend"]["long_exit"]["children"][0]["id"] == "legacy_exit"
...
def test_btc_regime_switch_uses_mep_state_sources_on_multitimeframe_frame():
    ...
    for index in range(420):
        ...
        candles.append([base_timestamp + index * 300_000, open_price, high_price, low_price, close_price, volume])
        price = close_price

    frame = runtime.build_frame("btc_regime_switch", template["default_config"], candles, "5m")
...
def test_runtime_supports_shifted_price_and_indicator_sources():
    ...
    config = {
        "indicators": {
            "ema_fast": {"label": "EMA", "type": "ema", "timeframe": "base", "params": {"period": 2}},
        },
        ...
        "trend": {
            ...
            "long_entry": build_group(
                ...
                "and",
                [
                    build_condition("prev_low_break", "上一根 low 小于 99", {"kind": "price", "field": "low", "bars_ago": 1}, "lt", {"kind": "value", "value": 99.0}),
                    build_condition("ema_turn_up", "当前 EMA 大于上一根 EMA", {"kind": "indicator", "indicator": "ema_fast", "output": "value"}, "gt", {"kind": "indicator", "indicator": "ema_fast", "output": "value", "bars_ago": 1}),
                ],
            ),
            "long_exit": build_group("trend_long_exit", "趋势做多离场", "or", []),
            "short_entry": build_group("trend_short_entry", "趋势做空入场", "and", [], enabled=False),
        ...
        "risk": {"stoploss": -0.05, "roi_targets": [], "trailing": {"enabled": False, "positive": 0.02, "offset": 0.03, "only_offset_reached": True}, "partial_exits": []},
    }
