...
class FreqtradeResearchService:
    ...
    def optimize_strategy(
        ...
        *,
        ...
        return (
            dict(best_iteration.config),
            {
                "metric": context.research.optimize_metric,
                "trial_count": len(trials),
                "best_score": best_score,
                "best_config": dict(best_iteration.config),
                "trials": trials,
            },
            best_iteration,
        )
    ...
    def serialize_iteration(self, result: IterationResult | None) -> dict[str, Any] | None:
        if result is None:
            return None
        return {
    ...
    @staticmethod
    def range_payload(start_date: datetime | None, end_date: datetime | None) -> dict[str, str] | None:
