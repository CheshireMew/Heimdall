...
from app.services.persistence_ports import CacheServicePort, KlineStorePort
...
class BinanceWeb3Service:
    def __init__(self, *, cache_service: CacheServicePort | None = None, kline_store: KlineStorePort) -> None:
